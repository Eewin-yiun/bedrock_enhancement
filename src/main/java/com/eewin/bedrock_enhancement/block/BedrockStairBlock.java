...
/**
 * 基岩楼梯 - 防爆，只能由基岩镐或带有基岩挖掘者附魔的钻石/下界合金镐挖掘
 * destroyTime=-1（原版基岩值），爆炸抗性极高
 */
public class BedrockStairBlock extends StairBlock {

    public BedrockStairBlock() {
        super(() -> ModBlocks.BEDROCK_BLOCK.get().defaultBlockState(),
                Properties.of()
